...
/*   Updated: 2020/05/21 07:52:08 by pacharbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					parse_tilde_exp(t_msh *data, char **string,
t_exp *exp, int assign);
...
int					cd_change_directory(t_msh *data, char *curpath, char *opr,
char *pwd);
int					cd_set_relativepath(t_msh *data, char *curpath, char *opr,
char *pwd);
